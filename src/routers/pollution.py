...
from db.repositories.city_repository import CityRepository
from db.repositories.pollution_repository import PollutionRepository
...
from services.pollution import fetch_pollution_by_coords, aggregated_pollutions
...
async def get_pollution_data(
    ...
    if city is not None:
        ...
        start = end = None
        if len(pollution) > 0:
            end = pollution[-1].date
            start = pollution[0].date
        return PollutionItemList(
